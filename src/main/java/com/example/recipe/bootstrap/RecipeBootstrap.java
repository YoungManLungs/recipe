...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.setDirections("Smash it like that like button nigga");

        Notes guacNotes = new Notes();
        guacNotes.setRecipeNotes("then put it on toast");
        ...
        tacosRecipe.setDirections("tacos, not too hard to figure out");

        Notes tacoNotes = new Notes();
        tacoNotes.setRecipeNotes("You'll probably be fine");
